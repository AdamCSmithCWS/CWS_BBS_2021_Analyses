...
parameters {
 ...
 //real<lower=1> nu;  //optional heavy-tail df for t-distribution
  ...
  real logsdyear[nstrata];    // sd of year effects
  
  real mulogsdyear;    // mean of log-scale of sd of year effects
 real<lower=0> sdlogsdyear;    // sd of log-scale of sd of year effects
...
model {
  ...
  sdlogsdyear ~ gamma(2,2); // prior on sd of yeareffects - stratum specific, and boundary-avoiding with a prior mode at 0.5 (1/2) - recommended by https://doi.org/10.1007/s11336-013-9328-2 
  mulogsdyear ~ normal(0,0.2); // prior on sd of yeareffects - stratum specific, and boundary-avoiding with a prior mode at 0.5 (1/2) - recommended by https://doi.org/10.1007/s11336-013-9328-2 
  logsdyear ~ normal(mulogsdyear,sdlogsdyear);
